...
def generator(cube, move_group):
        ...
        for p in positions[depth]:
            for m in move_group:
                ...
                if c.position not in position_set:
                    ...
                    if id % 50 == 0:
                        print_status(stdscr, depth, id, c.position, p.move_chain + [str(m)[5:]], color_dict)
    ...
    print_status(stdscr, depth, solution_id, SOLVED_POS, solution_move_chain, color_dict)
