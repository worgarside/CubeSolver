...
class Interface:
    def __init__(self, queue):
        ...
        self.lbl_move_sequence_title = Label(self.control_frame, text='Move Sequence: ', font='Microsoft\ YaHei\ UI 10',
                                          bg=bg_color)
        self.lbl_move_sequence_title.place(x=control_width / 20, y=160)

        self.lbl_move_sequence_moves = Label(self.control_frame, text='U', font='Courier\ New 13', bg=bg_color)
