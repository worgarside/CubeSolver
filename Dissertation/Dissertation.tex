...
\begin{document}
	...
	The drawings above show how each component will work and be built out of Lego, however a design for the whole robot is difficult to represent in drawings. For this reason, a 3-dimensional model of the robot was created in BrickLink's Stud.io software \cite{BrickLink} to create a full model representative of the final design. The components drawn above are rendered below for comparison and clarification on specific details and some parts may be hidden in the renders to show a clearer view of the parts.
	...
	Two large gears \legopiece{arg1} Figure \ref{fig:rdrWormGear} 
