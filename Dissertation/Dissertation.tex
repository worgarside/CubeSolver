...
\begin{document}
	...
	\begin{figure}[h!]
		...
		\begin{subfigure}[b]{0.4\linewidth}
			...
			\caption{Cube resting in the cradle}
		\end{subfigure}
		\begin{subfigure}[b]{0.4\linewidth}
			\includegraphics[width=\linewidth]{Resources/Images/CradleCurvedEdgeTilted.png}
			\caption{Cube being rotated out of the cradle}
		\end{subfigure}
    ...
    When a new color is on the Up face, the color sensor will be moved forwards until it is above the first edge cubie
