...
\lstset{ 
	...
	morekeywords={half_turn_lookup, },            % if you want to add more keywords to the set
...
|\fg \fo \fo \fy \fg \fg \fr \fr \fr \fb \fb \fw|
	...
	The vast majority of the milestone algorithms used for optimally solving a Cube are all based off their respective predecessors, with little complete originality. This proejct was developed with the intention of being as original as possible. Admittedly the multiphase solver is effectively an implementation of Kllosterman's 42-move algorithm, but this was to be the start of further developments into group creation and generation with robot compatible moves. The failures to complete these extended goals have been documented in this report to show that all avenues were considered in developing a reliable solution.
	...
	This would be a simple yet effective optimisation to add to either of the solvers (not including the half-turn solver) to reduce the number of positions generated/checked. Further analysis could be performed to compare the effectiveness of Manhattan distances vs. Euclidean distances.
	...
	Whilst Python's strengths have been demonstrated throughout this project, its weaknesses have also been highlighted: for rapid iterations, it has a much slower iterative rate than compiled languages such as C++. The scope of this project and limited knowledge of C++ led to the absence of C++ extensions through Boost.Python
	
    \newpage
    \chapter{Conclusions}
    
    The title of this project is \enquote{text}
    ...
    \begin{appendices}
		...
		\begin{table}[H]
			...
			\begin{tabular}{M{0.075\textwidth}M{0.175\textwidth}M{0.1\textwidth}M{0.1\textwidth}M{0.175\textwidth}M{0.1\textwidth}M{0.1\textwidth}}
				...
				3	&	\movesequencenospace{l'd'u'}	&	0.522	&	262	&	\movesequencenospace{b2r2b2}	&	6.545	&	\num{3501}	\\
				4	&	\movesequencenospace{u'l'd'u'}	&	6.530	&	3502	&	\movesequencenospace{r2b2r2b2}	&	87.324	&	\num{46740}	\\
				5	&	\movesequencenospace{d'u'l'd'u'}	&	86.904	&	\num{46741}	&	\movesequencenospace{b.r2b2r2b2}	&	\num{1149.732}	&	\num{621648}	\\
				6	&	\movesequencenospace{l'd'u'l'd'u'}	&	1165.350	&	\num{621649}	&	\movesequencenospace{r2b.r2b2r2b2}	&	\num{15053.421}	&	\num{8240086}	\\
				\bottomrule
			\end{tabular}
		\end{table}
