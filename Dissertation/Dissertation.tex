...
\begin{document}
	...
	\begin{center}
		\begin{ganttchart}[
			hgrid,x unit=0.475mm,
			vgrid={*{6}{draw=none},dotted},
			milestone/.append style={xscale=12.5},
			title height=.6,
			time slot format=isodate
			]{2017-07-03}{2018-04-29}
			\gantttitlecalendar{year, month=shortname} \\
			\ganttgroup{Robot}{2017-07-15}{2017-12-25} \\
			\ganttbar{Design}{2017-07-20}{2017-10-01} \\
			\ganttbar{Build}{2017-07-20}{2017-10-01} \\
			\ganttbar{Testing}{2017-07-20}{2017-10-01} \\
			\ganttbar{Refinement}{2017-07-20}{2017-10-01} \\
			\ganttmilestone{Complete}{2017-10-01}
