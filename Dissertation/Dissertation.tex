...
%			Valid Position		&	A position that can be achieved with a real-world Cube without dismantling it. \\
	...
	\textcolor{white}{
		\footnote{\label{footnote:metric}For this project the Half Turn Metric is used unless explicitly stated.}		
	}
    ...
    % TODO finish this and add a hardware section?
	\begin{table}[H]
		\def\arraystretch{1.25}
		\centering
...
|\fg \fo \fo \fy \fg \fg \fr \fr \fr \fb \fb \fw|
	...
	%TODO program vs. software terminology
